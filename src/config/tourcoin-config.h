/* src/config/tourcoin-config.h.  Generated from tourcoin-config.h.in by configure.  */
/* src/config/tourcoin-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef TRCN_CONFIG_H

#define TRCN_CONFIG_H
...
#define PACKAGE_BUGREPORT "https://tourcoin.org"

/* Define to the full name of this package. */
#define PACKAGE_NAME "TourCoin Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "TourCoin Core 2.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "tourcoin"
