...
/** Utility functions used by the TRCN Qt UI.
 */
namespace GUIUtil
{
...
// Render TRCN addresses in monospace font
...
// Parse "tourcoin:" URI into recipient object, return true on successful parsing
