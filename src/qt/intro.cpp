...
void Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("TourCoin Core"),
     ...
     * override -datadir in the tourcoin.conf file in the default data directory
     * (to be consistent with tourcoind behavior)
     */
    if (dataDir != getDefaultDataDirectory())
