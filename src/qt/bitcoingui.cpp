                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("TourCoin-Coin") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a TourCoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and tourcoin: URIs)"));
...
//AAAA LimxDev Coinmix Tab	
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About TourCoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about TourCoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for TourCoin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your TourCoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified TourCoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a TourCoin: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the TourCoin Core help message to get a list with possible TourCoin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("TourCoin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to TourCoin network", "", count));
}
...
{
    QString strTitle = tr("TourCoin Core"); // default title
