...
static Checkpoints::MapCheckpoints mapCheckpoints =
    boost::assign::map_list_of(0, uint256("0x000000dcd7347ddfdc284352d702448970a2e76a2c17cb24505c4ba475f20f85"));
;
static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1543850262, // * UNIX timestamp of last checkpoint block
...
public:
	...
	nMasternodeColleteralLimxDev = 5000; //Params().MasternodeColleteralLimxDev()
        ...
        const char* pszTimestamp = "TourCoin Experiment Goes Live";
        ...
        genesis.nVersion = 1;
        genesis.nTime = 1543850262;
        genesis.nBits = 0x1e0ffff0;
        genesis.nNonce = 20800097;
		
        hashGenesisBlock = genesis.GetHash();
	//printf("%s\n", hashGenesisBlock.ToString().c_str());
	//printf("%s\n", genesis.hashMerkleRoot.ToString().c_str());
        assert(hashGenesisBlock == uint256("0x000000dcd7347ddfdc284352d702448970a2e76a2c17cb24505c4ba475f20f85"));
        assert(genesis.hashMerkleRoot == uint256("0xda19c53715f972a8e8a2467ed8938d456b6f548505b17fbd30e4d4bf861aaed3"));
        

        vSeeds.push_back(CDNSSeedData("seed1.tourcoin.life", "seed1.tourcoin.life"));
        vSeeds.push_back(CDNSSeedData("seed2.tourcoin.life", "seed2.tourcoin.life"));
        vSeeds.push_back(CDNSSeedData("seed3.tourcoin.life", "seed3.tourcoin.life"));
        //vFixedSeeds.clear();
        //vSeeds.clear();
        ...
        nStartMasternodePayments = 1543850262; 
    }
...
public:
    CTestNetParams()
    {
        ...
        genesis.nTime = 1543850263;
        genesis.nNonce = 21809153;


        hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256("0x000002de7777341fb4c05377aff4b59c0f4fff332018a347c234a17f51fd5b74"));
        ...
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 193);
        // Testnet TourCoin BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet TourCoin BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet TourCoin BIP44 coin type is '1' (All coin's testnet default)
        ...
        nStartMasternodePayments = 1543850263;
    }
    const Checkpoints::CCheckpointData& Checkpoints() const
    {
        return dataTestnet;
...
public:
    CRegTestParams()
    {
        ...
        genesis.nTime = 1543850264;
        genesis.nBits = 0x207fffff;
        genesis.nNonce = 2;
		
        hashGenesisBlock = genesis.GetHash();
        nDefaultPort = 57123;
        assert(hashGenesisBlock == uint256("0x08f27c5ada53dea14c6aabfa6888a49ba50dcfd715230025b47aac4038e5fa6f"));
