...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("TourCoin Core tourcoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  tourcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded tourcoin transaction") + "\n" +
                               "  tourcoin-tx [options] -create [commands]   " + _("Create hex-encoded tourcoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded tourcoin transaction
