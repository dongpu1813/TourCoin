...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='tourcoin.conf'
CONFIGFOLDER='/root/.tourcoin'
COIN_DAEMON='tourcoind'
COIN_CLI='tourcoin-cli'
COIN_PATH='/usr/local/bin/'
COIN_REPO='https://github.com/TourCoinOfficial/TourCoin.git'
COIN_TGZ='https://github.com/TourCoinOfficial/TourCoin/releases/download/v2.0.0/TourCoin-linux.tgz'
