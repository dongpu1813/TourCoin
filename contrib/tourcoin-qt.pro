...
RESOURCES += src/qt/tourcoin.qrc src/qt/tourcoin_locale.qrc

TRANSLATIONS += src/qt/locale/tourcoin_bg.ts \
                src/qt/locale/tourcoin_de.ts \
                src/qt/locale/tourcoin_en.ts \
                src/qt/locale/tourcoin_es.ts \
                src/qt/locale/tourcoin_fi.ts \
                src/qt/locale/tourcoin_fr.ts \
                src/qt/locale/tourcoin_it.ts \
                src/qt/locale/tourcoin_ja.ts \
                src/qt/locale/tourcoin_pl.ts \
                src/qt/locale/tourcoin_pt.ts \
                src/qt/locale/tourcoin_ru.ts \
                src/qt/locale/tourcoin_sk.ts \
                src/qt/locale/tourcoin_sv.ts \
                src/qt/locale/tourcoin_vi.ts \
                src/qt/locale/tourcoin_zh_CN.ts \
                src/qt/locale/tourcoin_zh_TW.ts
